...
![image](Google-Calendar-AWS/AWS1.gif )
...
#### côté Serveur
Dans le fichier** index.js **se trouve la partie** serveur** où nous avons utilisé les différents **packages** dont nous avons 
besoins que ce soit pour le *démarrage de l'application, *le port utilisé*, *la base de données utilisée*...  etc
